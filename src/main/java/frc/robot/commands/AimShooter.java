...
public class AimShooter extends Command {
  ...
  public boolean isFinished() {
    boolean elevatorOnTarget =
        Math.abs(desiredElevatorHeight - Robot.elevator.getEncoderPosition())
            < ElevatorConstants.positionMaxError;
    boolean pivotOnTarget =
        Math.abs(desiredPivotAngle - Robot.pivot.getCurrentPosition())
            < PivotConstants.positionMaxError;
